...
MODEL_MAP = {
    ...
    "heart":     {"model": "heart_model.pkl", "imputer": "heart_imputer.pkl", "features": "heart_features.json", "title": "Heart Disease"},
    "kidney":    {"model": "kidney_model.pkl", "imputer": "kidney_imputer.pkl", "features": "kidney_features.json", "title": "Kidney Disease"},
}
